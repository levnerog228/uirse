...
# Конфигурация SAM2
CKPT_PATH = "checkpoints/sam22.1_hiera_large.pt"
CFG_PATH = "configs/sam22.1/sam22.1_hiera_l.yaml"
MASK_THRESHOLD = 0.5
SCORE_THRESHOLD = 0.9
MIN_AREA = 100
...
def init_sam():
    ...
    if sam2 is None:
        try:
            sam2 = build_sam2(CFG_PATH, CKPT_PATH)
            sam2.to(device).eval()
            predictor = SAM2ImagePredictor(sam2)
            print(f"[INFO] SAM2 initialized on {device}")
